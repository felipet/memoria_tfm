...
El primer resultado que se buscaba era observar el número de nodos que podían 
...
\incomment{hablar del proc. de calibración y decir que se ha calibrado aquí.}
...
?? se incluye una captura de dicho monitor. \incomment{explicar lo que haya si 
lo hay...} Como se ha mencionando anteriormente, este primero experimento busca 
...
\incomment{hablar del pll y relacionar con la teoría cuando esté}
